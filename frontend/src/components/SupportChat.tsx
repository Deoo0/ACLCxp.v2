...
const faqs: FAQ[] = [
    ...
    },
    {
        ...
        answer:
            "Each event has a unique QR code generated by the system. When you arrive at an event, scan the event's QR code to log your attendance. Once scanned, your merit points are automatically updated. Make sure you're registered and logged in before scanning.",
    ...
    {
        keywords: ["bookmark", "save", "favorite", "pin", "saved events", "unbookmark", "unsave"],
        answer:
            "Event bookmarking is coming soon! This feature will let you save events to the top of your dashboard for quick access. Stay tuned for updates.",
        suggestions: ["How do I view events?", "What is ACLCxp?"],
    },
    {
