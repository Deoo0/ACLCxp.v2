...
type Competition = {
  ...
  matches: { id: number; label: string; team_one: string; team_two: string; scheduled_at: string }[];
...
export default function CompetitionResults() {
  const [tab, setTab] = useState<"results" | "matches">("results");
