...
export default function RegisterPage() {
  ...
  const resetTicket = () => { setTicketVerified(false); stopCamera(); setMode("choose"); setError(""); setCameraError(""); }; const stage = step === "ticket" ? 1 : step === "student" ? 2 : 3;
