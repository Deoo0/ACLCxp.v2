...
export default function RegisterPage() {
  ...
  return <><SupportChat /><section className="relative min-h-screen overflow-hidden text-white"><img src="/aclcxp-bg.png" alt="" className="absolute inset-0 h-full w-full object-cover" /><div className="absolute inset-0 bg-black/70" /><main className="relative z-10 mx-auto flex min-h-screen w-full max-w-xl items-center px-5 py-10"><div className="w-full rounded-3xl border border-white/15 bg-slate-950/75 p-6 shadow-2xl backdrop-blur md:p-9">
