...
class Attendance(BaseModel):
    ...
    scanned_by = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, related_name="scanned_attendances"
    )

    scan_method = models.CharField(
        max_length=20, choices=SCAN_METHOD_CHOICES, default="QR_CODE"
    )
    ...
    scan_latitude = models.DecimalField(
        max_digits=10, decimal_places=8, null=True, blank=True
    )
    scan_longitude = models.DecimalField(
